...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'toast_animation_show_class' => env('SWEET_ALERT_TOAST_ANIMATION_SHOW_CLASS', 'animate__animated animate__fadeInRight'),
        'toast_animation_hide_class' => env('SWEET_ALERT_TOAST_ANIMATION_HIDE_CLASS', 'animate__animated animate__fadeOutRight'),
