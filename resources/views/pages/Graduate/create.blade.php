...
@section('content')
    <div class="card card-custom" id="background">
        ...
        <div class="background">
            <form action="{{ route('graduate.store') }}" method="POST" id="form">
                @csrf
                <div class="card-body">
                    <!--begin: Datatable-->
                ...
                <div class="card-footer text-center">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#message">Submit
                        Form</button>
                </div>
            </form>
            <div class="modal fade" id="message" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            Please check the grades of selected students
                            before submitting
                            the form.
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary font-weight-bold" id="submit">Ok</button>
                        </div>
                    </div>
                </div>
            </div>
