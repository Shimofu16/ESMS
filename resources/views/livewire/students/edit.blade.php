                    ...
                    <div class="card-body pt-4">
                      ...
                      <div>
                            ...
                            <div class="text-center justify-content-center mx-auto my-3">
                                <img class="rounded" src="{{ asset($student->image) }}" alt="Image" height="150px"
                                    width="150px">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <ul class="nav nav-tabs navi-item mb-2" role="tablist">
                                ...
                                <li role="presentation" class="navi-link py-4 d-flex justify-content-center mt-5">
                                    <button class="btn  btn-{{ $isEditable ? 'danger' : 'primary' }} w-100"
                                        wire:click="editMode">
                                        {{ $isEditable ? 'Cancel Edit' : 'Edit Student Information' }}
                                    </button>
                                </li>
                                @if ($student->status != 3)
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="personal">
                                                ...
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="middle_name"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="extension_name"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                ...
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            ...
                                                            wire:model="birthday" {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                ...
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="civil_status"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="nationality"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="contact_number"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="house_number"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                                ...
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <input class="form-control form-control-sm form-control-solid"
                                                            type="text" wire:model="municipality"
                                                            {{ $isEditable ? '' : 'disabled' }}>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-2">
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="documents">
                                                ...
                                                <div class="d-flex justify-content-end mt-5">
                                                    @if (!empty($student->document->student_id))
                                                        @if (empty(
                                                                $student->document->Form137 &&
                                                                    $student->document->JHS_cert &&
                                                                    $student->document->PSA &&
                                                                    $student->document->GoodMoral &&
            ...
            <div class="modal fade" id="dropStudent" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('students.enrolled.destroy', $student->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12 pt-3">
                                ...
                                <select class="custom-select custom-select-sm" name="reason_for_dropout" required>
                                    ...
                                    <option value="Transferred to International School">Transferred to International
                                        School</option>
                                    <option value="Acceleration (No Longer attending class)">Acceleration (No Longer
                                        attending class)</option>
                                    <option value="Physical conditions of classroom">Physical conditions of classroom
                                    </option>
                                    <option value="Peer Influences">Peer Influences</option>
                                    <option value="Distance between home and school">Distance between home and school
                                    </option>
                                    ...
                                    <option value="Lack of interest/Distractions">Lack of interest/Distractions
                                    </option>
                                    ...
                                    <option value="Parent's attitude toward schooling">Parent's attitude toward
                                        schooling</option>
                                </select>
                            </div>
